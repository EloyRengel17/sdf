...
const get_cliente= async (req, res) => {
    try{
        ...
        if(id){
            const sql=` FROM cliente.id, datos.nombre, datos.apellido, datos.cedula, datos.fecha_nacimiento, datos.horario_actividades, cliente.plan
            FROM cliente
            ...
            const sql=` SELECT cliente.id, datos.nombre, datos.apellido, datos.cedula, datos.fecha_nacimiento, datos.horario_actividades, cliente.plan
            FROM cliente
            JOIN datos on cliente.datos_cliente= datos.id`
